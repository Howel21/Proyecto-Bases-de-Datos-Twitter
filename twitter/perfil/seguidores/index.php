		...
		<div style="background: #4996FF; height: 150px; width: 100%;">
			...
			<div style="margin-left: 350px; margin-top: -155px;">
				<div id="link">
					...
					<div class="col-md-3" style="padding: 2px;"><a href="#">Siguiendo</a><br><b style="margin-left: 0px;"><a id="v" style="padding: 5px 30px;" href="../siguiendo/?cu=<?php echo $codigo_usuario; ?>"><?php echo $siguiendo; ?></a></b></div>
					<div class="col-md-3" style="padding: 2px;"><a href="#">Seguidores</a><br><b style="margin-left: 0px;"><a id="v" href="" style="padding: 5px 30px;"><?php echo $seguidores; ?></a></b></div>
					</div>
					</div>
				</div>
			</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
		    ...
		    if(codigo_usuario.length!=0){
			    $.ajax({
			        url: "../../clases/sig_seg.php?accion=2",
			        type: "post",
