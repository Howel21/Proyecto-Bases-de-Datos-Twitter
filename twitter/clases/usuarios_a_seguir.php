	...
	while ($usuario = oci_fetch_array($st, OCI_BOTH)) {
		echo '
			<div>
				...
				<br>
				<input style="background: #fff; border-radius: 20px; border: 1px solid #01A7F4; font-size: 12px; padding: 2px 20px; color: #01A7F4; position: absolute; margin-top: -40px; margin-right: 150px; margin-left: 65px;" type="button" value="Seguir" onclick="seguir('.$usuario['CODIGO_USUARIO'].', '.$codigo_usuario.')">
